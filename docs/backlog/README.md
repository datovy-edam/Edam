...
| PE-5 | Consumers + execution, in sub-steps: **5a** runner seam ✅ · **5b** asset-console adapter ✅ · **5c** real process (part 1 ✅) + Studio UI via DI (part 2 ✅) · **5d** retire the statics (**partial — needs a UI-execution design decision**) | Integration | Medium | L | **In Progress** (2026-09-18) — 5a–5c done; 5d: 3 dead members deleted + 5 deprecated; corrected finding: no reader refactor needed (materialization covers it) — blocker is a design decision (options A/B/C in the PE doc) |
