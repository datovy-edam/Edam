...
| PE-5 | Consumers + execution, in sub-steps: **5a** runner seam over `IProjectResources` ✅ · 5b asset-console adapter · 5c Studio UI · 5d retire the statics | Integration | Medium | L | **In Progress** — **5a done** (2026-09-18): `ProjectArgumentRunner` verified on **all 8 targets** incl. remote HTTP, CWD unchanged |
