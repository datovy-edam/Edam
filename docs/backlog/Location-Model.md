...
> **Status:** Started — **LM-1 DONE (2026-09-24; `address` conformance group ALL CONFORM, 19 checks)**; **LM-0 partial** — (a) ✅ seed source sanitized, (b) ✅ packaged-seed wiring implemented **and verified**, (c) ⏳ **re-scoped to LM-3** (the duplicated settings cannot be collapsed by data edits — see below); **next: LM-3**.
